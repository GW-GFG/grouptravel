    ...
    fetch("http://localhost:5500/users/updateNewUser", {
      ...
      .then((data) => {
        ...
        data.result &&
          dispatch(
            addUserToStore({
              token: data.updatedUser.token,
              username: data.updatedUser.username,
              userPicture: data.updatedUser.userPicture,
              email: data.updatedUser.email,
              myTrips: data.updatedUser.myTrips,
            })
          ) &&
  ...
  return (
    <div className={styles.mainContainer}>
      ...
      <div className={styles.errorsContainer}>
        ...
        {emptyField && (
          <p style={styles.error}>
            Veille a bien remplir tous les champs requis !
          </p>
        )}
